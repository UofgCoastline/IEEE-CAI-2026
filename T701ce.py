...
def test_precise_sea_cleanup():
    ...
    # 使用你现有的数据路径
    initial_dir = "C:/initial"
    ground_truth_dir = "C:/ground"
...
def process_all_coastal_data(self, initial_dir="C:/initial", ground_truth_dir="C:/ground",
...
def test_my_saved_model():
    ...
    initial_dir = "C:/initial"
    ground_dir = "C:/ground"
    output_dir = "./quick_test_results_OTHER"
    os.makedirs(output_dir, exist_ok=True)
